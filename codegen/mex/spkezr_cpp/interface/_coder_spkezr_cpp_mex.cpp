...
#include "_coder_spkezr_cpp_api.h"
                 ...
                 const mxArray *prhs[])
{
  ...
  mexAtExit(&spkezr_cpp_atexit);
  // Module initialization.
  spkezr_cpp_initialize();
  try {
...
// End of code generation (_coder_spkezr_cpp_mex.cpp)
